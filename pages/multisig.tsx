        ...
        <VStack w="full" spacing={{ base: "2.5rem", lg: "20px" }}>
          <Stack w="full" direction={{ base: 'column-reverse', lg: 'row' }} align="center">
            <VStack w="full" align="start" spacing={{ base: "2.5rem", lg: "20px" }}>
              <VStack w="full" pr={{ base: 0, lg: "50px" }} align="start" spacing="20px">
                <Heading m="0" as="h1" fontSize={{ base: SMALL_BASE_HEADING_SIZE, lg: LARGE_BASE_HEADING_SIZE }} fontWeight="700">About BANK</Heading>
                <Text m="0" fontSize={{ base: SMALL_BASE_TEXT_SIZE, lg: LARGE_BASE_TEXT_SIZE }} lineHeight="20px">
              ...
              <VStack w="full" pr={{ base: 0, lg: "50px" }} align="start" spacing="20px">
                <Heading m="0" as="h2" fontSize={{ base: SMALL_BASE_HEADING_SIZE, lg: "41px" }} fontWeight="700">Ways to Earn</Heading>
                <Text m="0" fontSize={{ base: SMALL_BASE_TEXT_SIZE, lg: LARGE_BASE_TEXT_SIZE }} lineHeight="20px">
          ...
          <Grid w="full" gap='5px' alignItems='center' templateColumns={{ base: "100%", lg: "10px 1fr 10px 1fr" }} templateRows={{ base: "repeat(7, 1fr)", lg: "repeat(4, 1fr)" }}>
            ...
            <GridItem rowStart={2}>
              <Text m="auto 0" textAlign="start" fontSize="14px" lineHeight="15px">BANK is available on both Sushiswap and Uniswap</Text>
            </GridItem>
          ...
          <VStack align="start" w="full">
            <Heading m="0" mb="20px" as="h2" size="l" fontSize={{ base: SMALL_BASE_HEADING_SIZE, lg : "41px" }}>Multisig Vaults</Heading>
            <Table maxWidth="full">
              <Thead>
                <Tr borderTop="1px solid white">
                  <Th className="vault-item" display={{ base: "none", lg: "table-cell" }} color="white" textTransform="none">#</Th>
                  <Th className="vault-item" color="white" textTransform="none">Guild</Th>
                  <Th className="vault-item" color="white" textTransform="none">Address</Th>
